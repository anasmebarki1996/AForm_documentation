...
function MaterialUiInputs() {
  ...
  const { submitHandler, resetFormState, loading, field, handleErrorsServer } =
    FormState(inputValues, submitFunction);
